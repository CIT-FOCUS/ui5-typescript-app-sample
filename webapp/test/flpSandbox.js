					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CIT Sample UI5 freestyle app",
									"targetURL": "#citsample-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"citsample-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=citsample",
									"url": sap.ui.require.toUrl("citsample")
								}
							}
						}
					}
